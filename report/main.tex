...
\begin{itemize}
    \item Full-text search is a primary requirement
    \item Queries involve single-table aggregations
    \item Data model is naturally denormalized
    \item Real-time document updates are needed
...
\begin{itemize}
    ...
    \item Storage efficiency is critical
\end{itemize}
